    ...
    <div>
      ...
      <div className="card section-gap">
        <div className="flex-between mb-16">
          ...
          <button className="btn btn-outline btn-sm" onClick={() => navigate('/detections')}>전체 보기</button>
        </div>
        <Table
          cols={detCols}
          rows={recentDets}
        ...
        <div className="grid-2 mt-20">
          <div className="card">
            <div className="flex-between mb-16">
              ...
              <button className="btn btn-outline btn-sm" onClick={() => navigate('/pauses')}>전체 보기</button>
            </div>
            {activePauses.length > 0
              ? <Table cols={pauseCols} rows={activePauses} onRowClick={() => navigate('/pauses')} />
              : <div className="empty">
